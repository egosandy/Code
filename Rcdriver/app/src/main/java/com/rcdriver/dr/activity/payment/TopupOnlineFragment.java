...
import com.rcdriver.dr.adapter.payment.JenisPaymentAdapter;
...
import com.rcdriver.dr.models.payment.Retail;
...
public class TopupOnlineFragment extends Fragment implements OnItemPaymentSelected {
    ...
    private LinearLayout laktif, lwaiting;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_topup_saldo, container, false);
        context = getActivity();
        user = BaseApp.getInstance(context).getLoginUser();
        nominal = view.findViewById(R.id.saldo);
        text1 = view.findViewById(R.id.text1);
        text2 = view.findViewById(R.id.text2);
        text3 = view.findViewById(R.id.text3);
        text4 = view.findViewById(R.id.text4);
        backBtn = view.findViewById(R.id.back_btn);
        recyclerView = view.findViewById(R.id.rec_metode);
        ...
        btnRiwayat = view.findViewById(R.id.btn_history);
        ...
        onItemPaymentSelected = new OnItemPaymentSelected() {
            @Override
            ...
            public void onResponse(Call<GetMethodResponse> call, Response<GetMethodResponse> response) {
                ...
                if(response.isSuccessful()){
                    if(response.body().getCode() == 200){
                        adapter = new JenisPaymentAdapter(context, response.body().getJenisPaymentList(), onItemPaymentSelected);
    ...
    private void postRetail(String method){
        ...
        requestPaymentJson.setId(method);
        requestPaymentJson.setIdUser(user.getId());
        requestPaymentJson.setNamaDepan(user.getFullnama());
        requestPaymentJson.setNamaBelakang(user.getFullnama());
        requestPaymentJson.setAmount(inputNominal);
        PaymentService service = ServiceGenerator.createService(PaymentService.class, user.getId(), user.getPhone());
    ...
    public void onResume() {
        ...
        if(user.getStatus().equalsIgnoreCase("1")){
            ...
            lwaiting.setVisibility(View.VISIBLE);
        }
    }
}