package com.rcdriver.dr.mwlib.AnimationClass;
...
import com.rcdriver.dr.mwlib.CallBacks.UpdateLocationCallBack;
import com.rcdriver.dr.mwlib.Utils.Utilities;
                            ...
                            if (!Utilities.isMarkerVisible(googleMap,newPosition)){
                                googleMap.animateCamera(CameraUpdateFactory
                                        .newCameraPosition(new CameraPosition.Builder()
                                                .target(newPosition)
                                                .bearing((float)Utilities.bearingBetweenLocations(startPosition, newPosition))
