package com.rcdriver.cs.activity.transfer;
...
import com.rcdriver.cs.json.SaldoReceiver;
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(phonenumber.getText().toString().isEmpty()) {
                    ...
                    cancel = true;
                    focus = nominal;
                }else if(Integer.parseInt(nominal.getText().toString()) < Integer.parseInt(sp.getSetting()[11])) {
                    nominal.setError("Transfer minimal " + Utility.toformatRupiah(sp.getSetting()[11]));
                    cancel = true;
                    focus = nominal;
                }else if(Integer.parseInt(saldo) - Integer.parseInt(nominal.getText().toString()) < Integer.parseInt(sp.getSetting()[12])) {
                    nominal.setError("Sisa saldo minimal " + Utility.toformatRupiah(sp.getSetting()[12]));
                    cancel = true;
                    focus = nominal;
