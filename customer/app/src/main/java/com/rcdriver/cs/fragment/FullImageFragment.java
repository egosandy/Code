...
public class FullImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fullpath = new File(Environment.getExternalStorageDirectory() + "/gojasa/" + chat_id + ".jpg");
        ...
        File direct = new File(Environment.getExternalStorageDirectory() + "/gojasa/");
    ...
    private void Savepicture(final boolean isfromshare) {
        if (Checkstoragepermision()) {
            ...
            final File direct = new File(Environment.getExternalStorageDirectory() + "/DCIM/gojasa/");
            progressDialog.show();
