...
public class BeritaDetailActivity extends AppCompatActivity {
    ...
    void clearGlideDiskCache() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                Glide.get(BeritaDetailActivity.this).clearDiskCache();
            }
        }).start();
    }
            ...
            public void onResponse(@NonNull Call<BeritaDetailResponseJson> call, @NonNull Response<BeritaDetailResponseJson> response) {
                if (response.isSuccessful()) {
                    ...
                    if (!berita.getFotoberita().isEmpty()) {
                        Glide.get(BeritaDetailActivity.this).clearMemory();
                        clearGlideDiskCache();
                        String baseurl = Constants.IMAGESBERITA + berita.getFotoberita();
