...
public class AllMerchantNearItem extends RecyclerView.Adapter<AllMerchantNearItem.ItemRowHolder> {
    ...
    public void onBindViewHolder(@NonNull final ItemRowHolder holder, final int position) {
        ...
        if (totalMenitNow <= totalMenitTutup && totalMenitNow >= totalMenitBuka) {
            holder.distance.setText(format + "km" + " " + mContext.getString(R.string.text_with_bullet) + " " + "Buka");
        } else {
            holder.distance.setText(format + "km" + " " + mContext.getString(R.string.text_with_bullet) + " " + "Tutup");
        }
