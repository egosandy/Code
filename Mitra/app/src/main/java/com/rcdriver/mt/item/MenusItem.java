...
import com.rcdriver.mt.activity.EditmenuActivity;
...
public class MenusItem extends RecyclerView.Adapter<MenusItem.ItemRowHolder> {
    ...
    public void onBindViewHolder(@NonNull final ItemRowHolder holder, final int position) {
        ...
        if (singleItem.getStatus_promo().equals("1")) {
            ...
            holder.shimmerview.startShimmer(); // <-- Corrected
            ...
            holder.shimmerview.stopShimmer(); // <-- Corrected
