...
public class CariAdapter extends RecyclerView.Adapter<CariAdapter.PredictionHolder> implements Filterable {
    ...
    public CariAdapter(Context context,LatLng latLng,double radius) {
        mContext = context;
        ...
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results != null && results.count > 0) {
                    ...
                    Log.e("Pencarian", "Gagal Konek Ke Api");
                }
            }
        };
    }
    ...
    public double[] getBoundsFromLatLng(double radius, double lat, double lng) {
        double lat_change = radius / Radius;
    ...
    private ArrayList<PlaceAutocomplete> getPredictions(CharSequence constraint) {
        ...
        sp = new SettingPreference(mContext);
        Log.i("CariLokasi", sp.getSetting()[6] + "," + sp.getSetting()[7]);
        double lat = Double.parseDouble(sp.getSetting()[6]);
        double lng = Double.parseDouble(sp.getSetting()[7]);
        double[] boundsFromLatLng = getBoundsFromLatLng(radius,lat,lng);
