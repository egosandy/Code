...
public class ActivityInfoMitra extends AppCompatActivity implements ItemItem.OnCalculatePrice {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderManual = findViewById(R.id.button5);
        ...
        orderManual.setVisibility(View.GONE);
        ...
        orderManual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityInfoMitra.this, OrderManualActivity.class);
                intent.putExtra("id", id);
                intent.putExtra("idfitur", idfitur);
                intent.putExtra("lat", lokasi.latitude);
                intent.putExtra("lon", lokasi.longitude);
                intent.putExtra("merlat", merlat);
                intent.putExtra("merlon", merlon);
                intent.putExtra("namamerchant", nama.getText().toString());
                intent.putExtra("idresto", idresto);
                intent.putExtra("alamat", alamat);
                intent.putExtra("alamatresto", alamatresto);
                intent.putExtra("tutupki", tutupki);
    ...
    public void calculatePrice() {
        ...
        if (quantity > 0) {
            ...
            pricecountainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (tutupki.equals("0")) {
                        Intent i = new Intent(ActivityInfoMitra.this, DetailOrderActivity.class);
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body() != null && "success".equalsIgnoreCase(Objects.requireNonNull(response.body()).getMessage())) {
                        ...
                        if (!response.body().getFotomerchant().isEmpty()) {
                            PicassoTrustAll.getInstance(ActivityInfoMitra.this)
                        ...
                        maps.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent i = new Intent(ActivityInfoMitra.this, MapsMerchantActivity.class);
                                i.putExtra("lat", lat);
                                i.putExtra("lon", lon);
                        ...
                        catMerchantNearItem = new CatItemItem(ActivityInfoMitra.this, response.body().getKategori(), R.layout.kategori_mitra, new CatItemItem.OnItemClickListener() {
                            @Override
                            public void onItemClick(final CatItemModel item) {
                                ...
                                FusedLocationProviderClient mFusedLocation = LocationServices.getFusedLocationProviderClient(ActivityInfoMitra.this);
                                mFusedLocation.getLastLocation().addOnSuccessListener(ActivityInfoMitra.this, new OnSuccessListener<Location>() {
                                    @Override
                                    public void onSuccess(Location location) {
                                        if (location != null) {
                        ...
                        orderManual.setVisibility(View.VISIBLE);
    ...
    private void LoadItem() {
        ...
        for (int i = 0; i < itemRealmResults.size(); i++) {
            ItemItem itemMenuItem = new ItemItem(ActivityInfoMitra.this, this);
    ...
    public void onBackPressed() {
        ...
        if (quantity > 0) {
            new AlertDialog.Builder(this, R.style.DialogStyle)
                    .setTitle("Hapus pesanan saat ini(s)?")
                    .setMessage("Meninggalkan halaman ini akan menyebabkan Anda kehilangan semua pesanan yang telah Anda buat. Melanjutkan?")
