...
import com.rcdriver.cs.dialog.DialogWallet;
import com.rcdriver.cs.models.WalletModel;
...
public class WalletItem extends RecyclerView.Adapter<WalletItem.ItemRowHolder> {
    ...
    private final List<WalletModel> dataList;
    ...
    public void onBindViewHolder(@NonNull final ItemRowHolder holder, final int position) {
        ...
        if (singleItem.getType().equals("withdraw")) {
            ...
            switch (singleItem.getStatus()) {
                ...
                case "0":
                    ...
                    holder.nominal.setTextColor(mContext.getResources().getColor(R.color.black));
                    holder.background.setColorFilter(mContext.getResources().getColor(R.color.hijau_color));
            ...
            holder.text.setTextColor(mContext.getResources().getColor(R.color.black));
            holder.nominal.setTextColor(mContext.getResources().getColor(R.color.black));
            holder.background.setColorFilter(mContext.getResources().getColor(R.color.greenColor));
            ...
            Utility.currencyTXT(holder.nominal, singleItem.getJumlah(), mContext);
            holder.text.setText(singleItem.getType() + " " + singleItem.getBank());
            holder.background.setColorFilter(mContext.getResources().getColor(R.color.black));
            holder.text.setTextColor(mContext.getResources().getColor(R.color.black));
            holder.nominal.setTextColor(mContext.getResources().getColor(R.color.hijau_color));
            holder.keterangan.setText("Pending");
            ...
            holder.text.setTextColor(mContext.getResources().getColor(R.color.black));
            holder.nominal.setTextColor(mContext.getResources().getColor(R.color.black));
            holder.background.setColorFilter(mContext.getResources().getColor(R.color.defaultfitur));
            holder.keterangan.setText("Money Out");
        ...
        } else if (singleItem.getType().equalsIgnoreCase("Tip")) {
            holder.text.setText(singleItem.getBank());
            Utility.currencyTXT(holder.nominal, singleItem.getJumlah(), mContext);
            holder.text.setTextColor(mContext.getResources().getColor(R.color.black));
            holder.nominal.setTextColor(mContext.getResources().getColor(R.color.black));
        ...
        } else if (singleItem.getType().equalsIgnoreCase("Donasi-")) {
            holder.text.setText(singleItem.getBank());
            Utility.currencyTXT(holder.nominal, singleItem.getJumlah(), mContext);
            holder.text.setTextColor(mContext.getResources().getColor(R.color.black));
            holder.nominal.setTextColor(mContext.getResources().getColor(R.color.black));
