package com.rcdriver.cs.activity.payment;
...
import com.rcdriver.cs.adapter.payment.JenisPaymentAdapter;
...
import com.rcdriver.cs.models.payment.Ewallet;
...
import com.rcdriver.cs.utils.OnItemPaymentSelected;
import com.rcdriver.cs.utils.api.ServiceGenerator;
import com.rcdriver.cs.utils.api.service.PaymentService;
...
public class TopupSaldoActivity extends AppCompatActivity implements OnItemPaymentSelected {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Add text change listener to the nominal EditText
        nominal.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                // Update the inputNominal value
                inputNominal = s.toString();
            }
