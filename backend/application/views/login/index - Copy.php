...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title><?=$this->config->item("APPNAME");?> Admin</title>
    <!-- plugins:css -->
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <div class="mt-5">
                                    ...
                                    <br>
                                    <span class="text-muted d-block text-center  justify-center ">Copyright © 2020 <a class="text-success" href="#"><?=$this->config->item("APPNAME");?></a>.</span>
                                </div>
                                <?= form_close(); ?>
                            </div>
                        </div>
