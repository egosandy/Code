...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'cs@murahati.my.id';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'cs@murahati.my.id';
   ...
   * @var string
   */
  public $Sender            = 'cs@murahati.my.id';
  ...
  */
   ...
   * @var string
   */
  public $Host          = 'mail.murahati.my.id';
   ...
   * @var string
   */
  public $Username      = 'cs@murahati.my.id';
 ...
 */
  ...
  */
  ...
  protected function EncodeFile($path, $encoding = 'base64') {
    try {
      ...
      // PHP 8: get_magic_quotes_runtime()/set_magic_quotes_runtime() dihapus.
      // Magic quotes sudah nonaktif permanen sejak PHP 5.4, jadi cukup baca file.
  ...
  */
  public function EncodeQPphp( $input = '', $line_max = 76, $space_conv = false) {
    ...
    $escape = '=';
    $output = '';
    foreach ($lines as $line) { // PHP 8: each() dihapus, diganti foreach (perilaku sama)
      $linlen = strlen($line);
      $newline = '';
      for($i = 0; $i < $linlen; $i++) {
        $c = substr( $line, $i, 1 );
